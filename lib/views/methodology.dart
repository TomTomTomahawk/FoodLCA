        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _Title('Data sources'),
              _Content(
                  'The sources of all the ingredients\' global warming potentials as well as calorie intensities can be found in a Google spreadsheet*. Global warming potential scores coming from meta-analyses in scientific journals are preferred. The USDA (United States Department of Agriculture) is usually the source for calorie intensities.'),
              Padding(
